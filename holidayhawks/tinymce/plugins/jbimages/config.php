...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'http://holidayhawks.in/editor_img'; // Relative to domain name
	//$config['img_path'] = 'http://crickjunction.com/blogs'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['upload_path'] ='C:/wamp/www/codegNew/blogs';
   $config['upload_path'] =$_SERVER['DOCUMENT_ROOT'].'/editor_img';
