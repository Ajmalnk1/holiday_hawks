                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								 ...
								 <div class="tab">
									  ...
									  <button data-val="amnities" class="tablinks amnities" onclick="openCity(event, 'amn')">Highlights</button>
								     ...
								     <div id="info" class="tabcontent">
										   ...
										   <div id="info_more">
											   <div class="form-group" >
												...
												<div class="col-lg-8">
													<input type="text" name="info_title[]" id="info_title"  value="<?php if(isset($info[0]->title)) echo $info[0]->title;?>" class="form-control info_title" required   placeholder="Type Here...">
									   ...
									   <div id="info_more1" class="col-lg-12 control-label" style="display:<?php  if(isset($info[1]->title)) echo 'block;'; else echo 'none;';?> border-top: 1px solid #333333; margin-top:20px;">
									   
											   <div class="form-group" >
												<label for="inputStandard" class="col-lg-3 control-label">Title</label>
												<div class="col-lg-8">
													<input type="text" name="info_title[]" id="info_title1"  value="<?php if(isset($info[1]->title)) echo $info[1]->title;?>" class="form-control info_title" required   placeholder="Type Here...">
									   ...
									   <div id="info_more2" class="col-lg-12 control-label" style="display:<?php if(isset($info[2]->title)) echo 'block;'; else echo 'none;';?> border-top: 1px solid #333333; margin-top:20px;">
											   <div class="form-group" >
												<label for="inputStandard" class="col-lg-3 control-label">Title</label>
												<div class="col-lg-8">
													<input type="text" name="info_title[]" id="info_title2"  value="<?php if(isset($info[2]->title)) echo $info[2]->title;?>" class="form-control info_title" required   placeholder="Type Here...">
									   ...
									   <div id="info_more3" class="col-lg-12 control-label" style="display:<?php if(isset($info[3]->title)) echo 'block;'; else echo 'none;';?> border-top: 1px solid #333333; margin-top:20px;">
											   <div class="form-group" >
												<label for="inputStandard" class="col-lg-3 control-label">Title</label>
												<div class="col-lg-8">
									...
									<div id="inclu" class="tabcontent">
											...
											<a href="#" id="add_inclu" class="add-user-btn" style="display:<?php if(count($inclu)==15) echo 'none';else echo 'block';?>">Add More</a>
										  ...
										  <?php for($i=0;$i<=15;$i++){?> 
										   <div id="inclu_more<?php echo $i+1;?>" class="col-lg-12 control-label" style="display:<?php  if(isset($inclu[$i]->title)) echo 'block;'; else echo 'none;';?>border-top: 1px solid #333333; margin-top:20px;">
										    ...
										    <div class="form-group" >
											 <label for="inputStandard" class="col-lg-3 control-label">Informations<span class="mandatory">*</span></label>
											   <div class="col-lg-8">
											  <textarea class="form-control itn_desc<?php echo $i+1;?>" name="itn_desc[]" id="itn_desc<?php echo $i+1;?>" required   placeholder="Type Here..."><?php if(isset($inclu[$i]->descr)) echo $inclu[$i]->descr;?></textarea>
											...
											<div class="dropzone cropping-inner-main new-album-file-upload"  style="border:1px solid #e3e3e3;">
											<?php foreach($iten1_q as $img): $temp_id[]=$img->temp_id;?>
											<div class="dz-preview" data-id="<?php echo $img->id;?>"><img src="<?php echo $img->image;?>" width="100" height="100" /><a class="dz-remove remove_db_gallery_itn" href="javascript:undefined;" data-id="<?php echo $img->id;?>" >Remove file</a></div>
											<?php endforeach;?>
											</div>
										  <?php 
