<?php 
  ...
  $submit_url=site_url('admin_vector/edit_form/'.$id);
											    ...
											    <label class="field select">
													<select  class="basic" name="link" id="link" >
														<option value="">Select</option>
														  ...
														  {
														   $link=$link->link_name;
														   $link_name='popular-packages/'.$link;
														  ...
														  <option value="<?php echo  $link_name;?>"<?php if((isset($link_db))&&($link_db==$link_name)) echo 'selected';?>><?php echo  $link;?></option>
														  <?php endforeach;?>
													</select>
													<i class="arrow"></i>
												</label>
