...
if($type=='exp_stays')
{
$submit_url=site_url('admin_exp_stays/edit_pkg_text_form');
$pg_title='Experiential Stays Text';
$base=base_url('admin_exp_stays');
}
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Other expertional Stays Description(in detail page)<span class="mandatory">*</span></label>
                                        <div class="col-lg-8">
                                 ...
                                 <div class="col-xs-2">
							           ...
							           <input type="submit" id="save_pkg_text" name="update_btn" value="Save" class="btn btn-rounded btn-primary btn-block" />
						          </div>
