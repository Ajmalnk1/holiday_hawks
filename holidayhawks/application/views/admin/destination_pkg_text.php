...
<header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail"> <a href="<?php echo base_url('admin_destination/pkg_text');?>">Destination Text</a></li>
                    </ol>
                </div>
							...
							<table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
								...
								<?php  $i=1; ?> 
									<tr class="li_banner">
										...
										<a href="<?php echo base_url('admin_destination/view_pkg_text_form');?>"><img title="Edit Banner" src="<?php echo base_url(ADMIN_LATEST.'img/edit.jpg');?>" width="15" height="15"></a>
