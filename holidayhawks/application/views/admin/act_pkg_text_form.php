...
if($type=='act')
{
$submit_url=site_url('admin_activities/edit_pkg_text_form');
$pg_title='Activities Text';
$base=base_url('admin_activities');
}
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Other Adventure Activities Description(in detail page)<span class="mandatory">*</span></label>
                                        <div class="col-lg-8">
