...
<header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail"> <a href="<?php echo base_url('admin_exp_stays/pkg_text');?>">Experiential Stays Text</a></li>
                    </ol>
                </div>
                   ...
                   <div class="col-md-12">
                        <div class="panel panel-visible">
							...
							<table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
								...
								<?php  $i=1; ?> 
									<tr class="li_banner">
										<?php /*?><td><?php echo $home_text->title;?></td><?php */?>
										<td><?php echo $home_text->exp_desc;?></td>
										<td>
										<?php /*?><a href="../<?php echo $arr['pglink'];?>" target="_blank"><img title="View Page" src="assets/img/view.jpg" width="15" height="15"></a><?php */?>
										<a href="<?php echo base_url('admin_exp_stays/view_pkg_text_form');?>"><img title="Edit Banner" src="<?php echo base_url(ADMIN_LATEST.'img/edit.jpg');?>" width="15" height="15"></a>
