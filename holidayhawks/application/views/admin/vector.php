...
<header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail"> <a href="<?php echo base_url('admin_vector');?>">Vector Categories</a></li>
                    </ol>
                </div>
												   ...
												   <h4 class="accordion-toggle" style="padding-right:0px;">
																<div class="learning-form-row" style="height:70px !important;">
																	...
																	<div class="learning-form-row-col-02 section-input leavel-01-input " style=" margin-left:151px !important;">
																		...
																		<a href="<?php echo base_url('admin_vector/view_form/'.$vector->id);?>"><button class="learning-form-edit" style="background:url(<?php echo base_url(IMG_PATH_ADMIN_LATEST.'edit.png');?>)no-repeat; right:212px "></button></a>
