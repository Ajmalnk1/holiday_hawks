                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="admin-form">
								  <div class="row">	
									<label for="inputStandard" class="col-lg-3 control-label">Select Experiential Stays Category<span class="mandatory">*</span></label>
									<div class="col-md-4">
											<div class="section">
											    ...
											    <label class="field select">
													<select  class="basic" name="cat" id="cat" >
														<option value="">Select</option>
														  <?php foreach($exp_cats as $exp_cat):?>
														  
														  <option value="<?php echo  $exp_cat->id;?>"<?php if((isset($cat_id))&&($cat_id==$exp_cat->id)) echo 'selected';?>><?php echo  $exp_cat->name;?></option>
														  <?php endforeach;?>
													</select>
													<i class="arrow"></i>
												</label>
