...
<header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail"><a href="<?php echo base_url('admin_activities_details');?>">Activities</a></li>
                    </ol>
                </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="admin-form">
								  <div class="row">	
									<label for="inputStandard" class="col-lg-3 control-label">Select Activity Category<span class="mandatory">*</span></label>
									<div class="col-md-4">
											<div class="section">
											    ...
											    <label class="field select">
													<select  class="basic" name="cat" id="cat" >
														<option value="">Select</option>
														  <?php foreach($act_cats as $act_cat):?>
														  
														  <option value="<?php echo  $act_cat->id;?>"<?php if((isset($cat_id))&&($cat_id==$act_cat->id)) echo 'selected';?>><?php echo  $act_cat->name;?></option>
														  <?php endforeach;?>
													</select>
													<i class="arrow"></i>
												</label>
								...
								<div class="form-group" >
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="category" id="category"  value="<?php if(isset($category)) echo $category;?>"  class="form-control" required   placeholder="Type Here...">
											
                                        </div>
                                </div>
								
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Trial Type</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="trial_type" id="trial_type"  value="<?php if(isset($trial_type)) echo $trial_type;?>"  class="form-control" required   placeholder="Type Here...">
								...
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Duration</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="duration" id="duration"  value="<?php if(isset($duration)) echo $duration;?>"  class="form-control" required   placeholder="Type Here...">
											
                                        </div>
                                </div>
								
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Min Age</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="min_age" id="min_age"  value="<?php if(isset($min_age)) echo $min_age;?>"  class="form-control" required   placeholder="Type Here...">
