...
if($type=='destination')
{
$submit_url=site_url('admin_destination/edit_pkg_text_form');
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<div class="form-group" >
                                        <label for="inputStandard" class="col-lg-3 control-label">Title in detail listing page<span class="mandatory">*</span></label>
                                        <div class="col-lg-8">
