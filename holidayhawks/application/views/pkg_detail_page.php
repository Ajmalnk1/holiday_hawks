		   ...
		   <form id="myform">
		    <div class="enquiry-form-row">
				<div class="enquiry-form-col-01" style="width:100%">
					...
					<input type="hidden" id="title" value="<?php echo $pkg_detail['main_detail']->title;?>">
					<input type="hidden" id="price" value="<?php echo $pkg_detail['main_detail']->price;?>">
			...
			<div class="form-price">
				<p><?php echo $pkg_detail['main_detail']->price;?></p>
