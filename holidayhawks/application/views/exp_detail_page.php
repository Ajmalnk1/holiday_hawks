...
<body>
	<div class="book-now-pop-up" style="display:none; height:625px;">
		<h1><?php echo $exps['main_detail']->title;?></h1>
		   ...
		   <form id="myform">
		    <div class="enquiry-form-row">
				<div class="enquiry-form-col-01" style="width:100%">
					...
					<input type="hidden" id="title" value="<?php echo $exps['main_detail']->title;?>">
					<input type="hidden" id="price" value="<?php echo $exps['main_detail']->price;?>">
			...
			<div class="form-price">
				<p><?php echo $exps['main_detail']->price;?></p>
	...
	<div class="wrapper">
		...
		<section class="blog-list-main">
			<div class="inner-page-banner">
				...
				<img src="<?php if(isset($exps['main_detail']->banner_img)) echo $exps['main_detail']->banner_img;?>" alt="" style="margin-top:-0;">
			</div>
			<div class="details-page-con" style="background:#FFF;">
				<div id="details-nav" class="details-page-header">
					<div class="container">
						<h1><?php if(isset($exps['main_detail']->title)) echo $exps['main_detail']->title;?></h1>
						<div class="book-now">Book Now</div>
						<div class="show-price">
							<p><?php if(isset($exps['main_detail']->price)):?><img src="<?php echo base_url(IMG_PATH_NEW.'inr.png');?>" alt=""><?php echo $exps['main_detail']->price;?><?php endif;?></p>
					...
					<div class="details-main-con">
						...
						<div id="horizontalTab">
							<ul class="resp-tabs-list">
								...
								<li class="button button--wapasha button--round-s">Amenities</li>
							...
							<div class="resp-tabs-container">
								<div>
									<div class="page-section details-row">
										...
										<div class="about-left-con">
											<?php if(isset($exps['about']->about)) echo $exps['about']->about;?>
										</div>
										<div class="about-right-con">
											<div class="itinary-img">
												<div class="gallery-main">
													...
													<?php if(isset($exps['about_gallery'])): foreach($exps['about_gallery'] as $img){?>
											            <div class="item">
								...
								<div>
									<div class="page-section details-row">
										...
										<div class="gallery-main">
											...
											<?php if(isset($exps['gallery'])): foreach($exps['gallery'] as $img){?>
									            <div class="item">
									...
									<div class="page-section details-row">
										<div class="tab-content">
			                                ...
			                                <div class="tab-pane fade active in" id="hotel-amenities">
			                                    <h1>Amenities</h1>
			                                    <?php if(isset($exps['amn']->amn)) echo $exps['amn']->amn;?>
								...
								<div>
									<div class="page-section details-row">
										...
										<div class="information-left">
											<ul>
											<?php if(isset($exps['info'])): $i=1;foreach($exps['info'] as $info){?>
								...
								<div>
									<div class="page-section details-row">
									<h1>Inclusions</h1>
										<?php if(isset($exps['inclusion']->inclusion)) echo $exps['inclusion']->inclusion;?>
									</div>
								</div>	
								<!--<div>
									<div class="page-section details-row">
