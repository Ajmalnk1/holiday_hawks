		...
		<section class="blog-list-main">
			<div class="inner-page-banner">
				<div class="inner-page-banner-shade">
					<h1 class="fadeInUp animated"><?php echo $exp['title'];?></h1>
				</div>
				<img src="<?php echo $exp['banner_img'];?>" alt="" style="margin-top:-100px;">
			</div>
			<div class="blog-grid">
				<div class="container">
					<div class="row">
						<div class="welcome-title">
							<p><?php echo $exp['detail_descr1'];?></p>
							
						</div>
						<div class="col-md-12 col-sm-12">
							<div class="package-list-row">
								<h1><?php echo $exp['detail_name'];?></h1>
								<p><?php echo $exp['detail_descr2'];?></p>
							</div>
							<div class="package-list-slide">
								<div class="gallery-main">
									<ul class="grid effect-2" id="grid">
									  <?php if(isset($exp['destinations'])):  foreach($exp['destinations'] as $destination_details){?>
										<li>
											<div class="packit-item-img eperiential-img">
							            		<a href="<?php echo base_url('experiential-stays/'.str_replace(" ","-",$exp['title']).'/'.str_replace(" ","-",$destination_details->name));?>">
