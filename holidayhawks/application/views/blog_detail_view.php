...
<?php
					 function breezer_addDivToImage( $content )
					 {
					   ...
					   $replacement = '<div class="blog-details-banner">$1</div>';
					...
					//echo breezer_addDivToImage(str_replace('<p>&nbsp;</p>','',$content)); 
			  ?> 
					...
					<div class="row">
						<div class="col-md-9  col-sm-12 col-xs-12">
							<div class="singlepost">
								<div class="blog-details-banner"><img style="width:100%" src="<?php echo $blog['cover_img']; ?>" alt="Holidayhawks"></div>
								...
								<p><?php echo breezer_addDivToImage($blog['content']);?>  </p>
							</div>
						   ...
						   <?php if(isset($blog['other_blog'])&&count($blog['other_blog'])>0): ?>
							<div class="widget">
								...
								<ul class="comments-list">
									...
									<li>
										<div class="alignleft">
											<a href="<?php echo base_url('blog/'.str_replace(' ', '-',$other_blog_val->title));?>"><img src="<?php echo $other_blog_val->cover_img;?>" alt="Holidayhawks"></a>
										</div>
										<!--<small>11.08.2016</small>-->
										<h3><a href="<?php echo base_url('blog/'.str_replace(' ', '-',$other_blog_val->title));?>" title=""><?php echo $other_blog_val->title;?></a></h3>
									</li>
									<?php endforeach;?>
								</ul>
							</div>
